/**
 * Created by Shivendra HP on 27-05-2018.
 */
...
public class HomeComment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homecomment);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        thought =(TextView)findViewById(R.id.thoughtOndiscussion);  // to change
    ...
    public void onBackPressed() {
        Intent i = new Intent(HomeComment.this, drawer.class);
        Bundle b = new Bundle();
        b.putString("f","polls");
        b.putInt("position",position);
        i.putExtras(b);
        startActivity(i);
        HomeComment.this.finish();
